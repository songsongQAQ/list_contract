  ...
  try {
    ...
    const config = await prisma.userConfig.upsert({
      ...
      update: {
        ...
        longLeverage: body.longLeverage || '50',
        longMargin: body.longMargin || '3',
        shortLeverage: body.shortLeverage || '50',
        shortMargin: body.shortMargin || '3',
        defaultLimit: body.defaultLimit || '10',
